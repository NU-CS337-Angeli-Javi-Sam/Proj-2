class CookingToolsOntology:
    def __init__(self):
        self.categories = {
            "Cutting Tools": ["knife", "scissors", "mandoline", "peeler", "grater", "zester", "shears", "cleaver", "paring knife", "bread knife", 'ricer'],
            "Cooking Vessels": ["bowl", "pot", "pan", "skillet", "wok", "saucepan", "roasting pan", "casserole dish", "stockpot", "Dutch oven", "grill pan"],
